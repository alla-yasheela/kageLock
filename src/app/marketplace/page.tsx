...
export default function MarketplacePage() {
  ...
  const assets: Asset[] = [
    ...
    {
      id: 2,
      title: "Payment Processing Algorithm",
      category: "code",
    ...
    },
    {
      ...
      reviews: 58,
      price: "$99",
      tags: ["Marketing", "Strategy", "Template"],
      date: "2 weeks ago",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      reviews: 113,
      price: "$799",
      tags: ["E-commerce", "Backend", "Scalable"],
      date: "5 days ago",
    },
    {
      id: 6,
    ...
    {
      id: 8,
      title: "AI Image Recognition Algorithm",
      category: "code",
        ...
        <div className="container-width">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              Discover and license intellectual property assets from creators around the world
            </p>
          </div>
